...
public class Animation {
	...
	/**
	 * Gets the frame 'i' associated with the current image. This may be
	 * useful to find which frame the current sprite is on
	 * 
	 * @return	The index 'i' for current frame
	 */
	 ...
	 */
	public void setLoop(boolean shouldLoop) { loop = shouldLoop; }
	...
	/**
	 * Sets the looped variable
	 * 
	 * @param shouldLoop True if it should loop continuously.
	 */
	
	public void setTheLoop(boolean shouldLoop) { looped = shouldLoop;}
